...
const PredictionResult = ({ result }) => {
  ...
  //         <div className={`w-12 h-12 bg-${confidenceInfo.color}-100 rounded-full flex items-center justify-center`}>
  //           <span className="text-2xl font-bold text-gray-800">{result.prediction}</span>
  //         </div>
  //         <div>
  ...
  //         <span className="font-medium">{confidenceInfo.label} Confidence</span>
  //       </div>
  //     </div>
  ...
  //         <div
  //           className={`bg-${confidenceInfo.color}-500 h-2 rounded-full transition-all duration-500`}
  ...
  //       <button 
  //         onClick={() => navigator.clipboard?.writeText(result.prediction)}
